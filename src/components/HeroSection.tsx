    ...
    <div id='HeroSection' className='min-h-screen w-screen overflow-x-hidden flex items-center justify-center'>
      ...
      <div className="relative  w-full bg-gradient-to-r flex items-center justify-center">
        ...
        <Image width={260} height={100} src="/images/cube-in-left-medium.png" alt="left-medium"
          className="absolute left-40 top-10 object-cover animate-cube-float-medium" />

        <Image width={260} height={100} src="/images/cube-in-left-small.png" alt="left-small"
          className="absolute left-28 top-16 object-cover animate-cube-float-small" />
